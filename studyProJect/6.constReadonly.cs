...
namespace projectstudy
{
    ...
    {
        /*요약
        * const : 컴파일상수 (생성시초기화) , 정수,실수,enum,string 타입만 사용 가능 , stack 메모리할당 (static 선언시 heap 메모리 저장가능  , stack 메모리에 할당해 속도가 빠름
        * read  : 런타임상수 (생성시 초기화 필요없음) ,생성자 단계에서 초기화가능 , 모든 자료형 이용가능 , heap메모리 할당 
        * 
        */
